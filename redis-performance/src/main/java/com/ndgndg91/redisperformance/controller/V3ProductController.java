...
import com.ndgndg91.redisperformance.service.V3ProductService;
...
public class V3ProductController {
    ...
    private final V3ProductService service;

    @GetMapping("/v3/apis/products/{id}")
    ...
    @PutMapping("/v3/apis/products/{id}")
